...
class TestAppGenerateTransaction(unittest.TestCase):
    ...
    def test_missing_receipts(self,
        ...
        mock_get_receipts_by_status_with_items_and_accounts.assert_called_once_with([5], 10)
    ...
    def test_with_receipts(self,
        ...
        mock_get_receipts_by_status_with_items_and_accounts.assert_called_once_with([5], 15)
    ...
    def test_with_receipts_transaction(self,
        ...
        mock_get_receipts_by_status_with_items_and_accounts.assert_called_once_with([5], 20)
        mock_convert.assert_called_once_with(['receipt1', 'receipt2'])
